          ...
          style={{
            ...
            ...(isMobile
              ? {
                  ...
                  backgroundImage: 'linear-gradient(45deg, #c0c0c0 25%, transparent 25%, transparent 75%, #c0c0c0 75%), linear-gradient(45deg, #c0c0c0 25%, transparent 25%, transparent 75%, #c0c0c0 75%)',
        ...
        >
          <div
            style={{
              ...
              backgroundColor: isMobile ? 'transparent' : '#e0e0e0',
              backgroundImage: isMobile ? 'none' : 'linear-gradient(45deg, #c0c0c0 25%, transparent 25%, transparent 75%, #c0c0c0 75%), linear-gradient(45deg, #c0c0c0 25%, transparent 25%, transparent 75%, #c0c0c0 75%)',
